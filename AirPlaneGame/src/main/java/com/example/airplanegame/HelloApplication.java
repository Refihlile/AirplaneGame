...
public class HelloApplication extends Application {
    ...
    //public class HelloApplication extends Application {
        ...
        private ImageView createFirstCloud() {
            ImageView image1 = new ImageView(new Image("cloud2.ico"));
        ...
        private ImageView createSecondCloud() {
            ImageView image2 = new ImageView(new Image("cloud2.ico"));
        ...
        private ImageView createThirdCloud() {
            ImageView image3 = new ImageView(new Image("cloud.ico"));
        ...
        private ImageView createFourthCloud() {
            ImageView clout4 = new ImageView(new Image("cloud.ico"));
        ...
        private ImageView createFifthCloud() {
            ImageView cloud5 = new ImageView(new Image("cloud.ico"));
        ...
        private ImageView createSixthCloud() {
            ImageView cloud6 = new ImageView(new Image("cloud.ico"));
        ...
        private ImageView createSeventhCloud() {
            ImageView cloud7 = new ImageView(new Image("cloud.ico"));
        ...
        private ImageView createEighthCloud() {
            ImageView cloud8 = new ImageView(new Image("cloud.ico"));
        ...
        private ImageView createNinthCloud() {
            ImageView cloud9 = new ImageView(new Image("cloud1.ico"));
        ...
        private ImageView createTenthCloud() {
            ImageView cloud10 = new ImageView(new Image("cloud.ico"));
